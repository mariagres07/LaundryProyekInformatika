...
Route::get('/karyawan/edit/{idKaryawan}', [KaryawanController::class, 'edit'])->name('karyawan.edit');
Route::put('/karyawan/update/{idKaryawan}', [KaryawanController::class, 'update'])->name('karyawan.update');
Route::delete('/karyawan/hapus/{idKaryawan}', [KaryawanController::class, 'destroy'])->name('karyawan.destroy');
