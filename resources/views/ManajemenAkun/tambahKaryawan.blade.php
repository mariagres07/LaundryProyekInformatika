...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="card shadow p-4" style="max-width: 600px; width:100%;">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/karyawan/store') }}"> <!-- Pastikan action sesuai -->
                @csrf
                <div class="mb-3">
                    <label class="form-label">Nama Lengkap *</label>
                    <input type="text" name="namaKaryawan" class="form-control" value="{{ old('namaKaryawan') }}" required>
                    @error('namaKaryawan')
...
<script>
    const password = document.querySelector('input[name="password"]'); // Gunakan selector umum
    const rules = {
    ...
    // Hanya aktifkan validasi jika input password ditemukan
    if (password) {
  ...
  <a href="{{ url('/karyawan') }}" class="btn-back" title="Kembali">
    <i class="bi bi-arrow-left"></i> <!-- Gunakan ikon Bootstrap jika tersedia -->
</a>
