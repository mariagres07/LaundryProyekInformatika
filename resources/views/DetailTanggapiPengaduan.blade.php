                ...
                <div class="card-body">
                    ...
                    @if($pengaduan->tanggapanPengaduan)
                        <div class="mb-4 p-3 border rounded bg-light">
                            <h6 class="fw-bold text-primary">Tanggapan Anda:</h6>
                            <p class="mb-0">{{ $pengaduan->tanggapanPengaduan }}</p>
                            @if($pengaduan->status == 'Ditanggapi')
                                <small class="text-muted">Ditanggapi pada: {{ \Carbon\Carbon::now()->format('d/m/Y H:i') }}</small>
                            @endif
                        </div>
                    @endif
