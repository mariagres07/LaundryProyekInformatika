...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="status-card">
            <h5 class="fw-bold text-primary mb-3">Status Pesanan</h5>

            @php
            $statuses = ['Menunggu Penjemputan', 'Menunggu Pembayaran', 'Diproses', 'Menunggu Pengantaran', 'Sudah
            Diantar', 'Selesai'];
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between fw-bold fs-5">
                        ...
                        <span class="text-success">Rp
                            {{ number_format(($pesanan->total_harga + $pesanan->biaya_pengantaran) ?? 0, 0, ',', '.') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="info-card">
            ...
            <div class="text-center">
                <p class="text-muted">Jika ada pertanyaan mengenai pesanan Anda</p>
        ...
        <div class="info-card text-center">
            <a href="{{ route('lihatdata.index') }}" class="btn btn-secondary">
